...
class NLPFlow(FlowSpec):
    ...
    epochs = Parameter("epochs", default=10, type=int, help="Number of epochs")
    ...
    def train(self):
        ...
        model.fit(X=self.df["review"], y=self.df["labels"], epochs=self.epochs)
    ...
    def end(self):
        ...
        check_1 = _test_preds[0] < 0.5
        check_2 = _test_preds[1] >= 0.5
